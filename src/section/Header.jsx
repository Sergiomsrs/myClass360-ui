...
export const Header = () => {
  ...
  // Cierra el menú de producto si se hace clic fuera (desktop)
  useEffect(() => {
  ...
  // Cierra el menú móvil si se hace clic fuera (mobile)
  useEffect(() => {
    if (!open) return;
    function handleClick(e) {
  ...
  return (
    <header className="bg-white">
      ...
      {open && (
        <div className="lg:hidden" role="dialog" aria-modal="true" ref={mobileRef}>
